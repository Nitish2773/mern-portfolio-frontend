// frontend/src/admin/forms/EducationForm.jsx
import React, { useState, useEffect } from "react";

export default function EducationForm({ data, onSave, onCancel }) {
  const initialForm = {
    logo: "",
    institution: "",
    program: "",
  ...
  const handleSubmit = (e) => {
    ...
    if (typeof onSave === "function") {
      ...
      console.warn("⚠️ onSave prop not provided to EducationForm");
    }
  };
  ...
  const handleCancel = () => {
    if (typeof onCancel === "function") {
      ...
      console.warn("⚠️ onCancel prop not provided to EducationForm");
    }
  };
