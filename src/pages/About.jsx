  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={DataEngineerImg} alt="Data Engineer" className="w-full h-full object-cover" loading="lazy" />
        </motion.div>

        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 dark:text-gray-100 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-gray-500 dark:text-gray-400 text-xl mt-4">
          {social.github && <a href={social.github} target="_blank" rel="noreferrer" className="hover:text-sriBlue-500 dark:hover:text-sriTeal-400 transform hover:scale-125"><FaGithub /></a>}
          {social.linkedin && <a href={social.linkedin} target="_blank" rel="noreferrer" className="hover:text-sriBlue-500 dark:hover:text-sriTeal-400 transform hover:scale-125"><FaLinkedin /></a>}
          {social.twitter && <a href={social.twitter} target="_blank" rel="noreferrer" className="hover:text-sriBlue-500 dark:hover:text-sriTeal-400 transform hover:scale-125"><FaTwitter /></a>}
          {social.telegram && <a href={social.telegram} target="_blank" rel="noreferrer" className="hover:text-sriBlue-500 dark:hover:text-sriTeal-400 transform hover:scale-125"><FaTelegram /></a>}
          {social.facebook && <a href={social.facebook} target="_blank" rel="noreferrer" className="hover:text-sriBlue-500 dark:hover:text-sriTeal-400 transform hover:scale-125"><FaFacebook /></a>}
        </div>
      </motion.div>
    </motion.section>
  );
